const movies = [
  {
    ...
    summary: "Patton Oswald, despite a personal tragedy, produces his best standup yet. Focusing on the tribulations of the Trump era and life after the loss of a loved one, Patton Oswalt continues his journey to contribute joy to the world.",
...

  {
    ...
    "fulltitle": "Lucknow Central (2017)",
    "movie_year": 2017,
...
const searchMoviesBtn = document.getElementById("searchMovies");
const typeFilter = document.getElementById("typeFilter");
const sortFilter = document.getElementById("sortFilter");

// Filmlarni ekranga chiqarish
...
function sortMovies() {
  ...
  else if (sortOption === "title-desc") sortedMovies.sort((a, b) => b.Title.localeCompare(a.Title));
  else if (sortOption === "rating-asc") sortedMovies.sort((a, b) => a.imdb_rating - b.imdb_rating);
  else if (sortOption === "rating-desc") sortedMovies.sort((a, b) => b.imdb_rating - a.imdb_rating);
